...
#7037  in mith''s list of 63,137 min-expand puzzles in T&E(3)
...
! 7 4 . ! 8 . . ! . . . !
+-------+-------+-------+
...45..89....8....8..3.75.4.3.97..5..7..48..3...5.3..7..2.....56.1...9..74.8.....;1558;26960


(solve "...45..89....8....8..3.75.4.3.97..5..7..48..3...5.3..7..2.....56.1...9..74.8.....;1558;26960")
***********************************************************************************************
...
Resolution state after Singles:
   +----------------------+----------------------+----------------------+
   ! 123    126    367    ! 4      5      126    ! 12367  8      9      !
   ! 123459 12569  345679 ! 126    8      1269   ! 12367  12367  126    !
   ! 8      1269   69     ! 3      1269   7      ! 5      126    4      !
   +----------------------+----------------------+----------------------+
   ! 124    3      468    ! 9      7      126    ! 12468  5      1268   !
   ! 1259   7      569    ! 126    4      8      ! 126    1269   3      !
   ! 1249   12689  4689   ! 5      126    3      ! 12468  12469  7      !
   +----------------------+----------------------+----------------------+
   ! 39     89     2      ! 167    1369   1469   ! 134678 13467  5      !
   ! 6      58     1      ! 27     23     245    ! 9      2347   28     !
   ! 7      4      359    ! 8      12369  12569  ! 1236   1236   126    !
   +----------------------+----------------------+----------------------+

193 candidates, 1212 csp-links and 1212 links. Density = 6.54%
...
OR6-anti-tridagon[12] for digits 1, 2 and 6 in blocks:
        b2, with cells: r1c6, r2c4, r3c5
        b3, with cells: r1c7, r2c9, r3c8
        b5, with cells: r4c6, r5c4, r6c5
        b6, with cells: r4c9, r5c7, r6c8
with 6 guardians: n3r1c7 n7r1c7 n9r3c5 n8r4c9 n4r6c8 n9r6c8

z-chain[4]: r2n4{c1 c3} - r2n5{c3 c2} - b7n5{r8c2 r9c3} - c3n3{r9 .} ==> r2c1≠3
z-chain[4]: r2n4{c3 c1} - c1n5{r2 r5} - r5c3{n5 n9} - r3c3{n9 .} ==> r2c3≠6
z-chain[4]: r2n4{c3 c1} - c1n5{r2 r5} - r5c3{n5 n6} - r3c3{n6 .} ==> r2c3≠9
t-whip[4]: r2n4{c1 c3} - c3n7{r2 r1} - c3n3{r1 r9} - r7c1{n3 .} ==> r2c1≠9
biv-chain[3]: r2n9{c6 c2} - c2n5{r2 r8} - b8n5{r8c6 r9c6} ==> r9c6≠9
...
whip[5]: r9n5{c6 c3} - r8c2{n5 n8} - r8c9{n8 n2} - r9n2{c9 c5} - r9n9{c5 .} ==> r9c6≠1
whip[5]: r9n5{c6 c3} - r8c2{n5 n8} - r8c9{n8 n2} - r9n2{c9 c5} - r9n9{c5 .} ==> r9c6≠6
...
There remains a Trid-OR5-relation between candidates: n3r1c7 n7r1c7 n8r4c9 n4r6c8 n9r6c8

   +----------------------+----------------------+----------------------+
   ! 123    126    37     ! 4      5      126    ! 12367  8      9      !
   ! 45     12569  3457   ! 126    8      1269   ! 12367  12367  126    !
   ...
   ! 1249   1269   4689   ! 5      126    3      ! 12468  12469  7      !
   +----------------------+----------------------+----------------------+
   ! 39     89     2      ! 167    136    146    ! 134678 13467  5      !
   ! 6      58     1      ! 27     23     245    ! 9      2347   28     !
   ! 7      4      35     ! 8      9      25     ! 1236   1236   126    !
   +----------------------+----------------------+----------------------+

hidden-single-in-a-block ==> r2c6=9
whip[1]: r9n1{c9 .} ==> r7c7≠1, r7c8≠1
whip[1]: r9n6{c9 .} ==> r7c7≠6, r7c8≠6
z-chain[3]: r9n2{c9 c6} - c6n5{r9 r8} - r8n4{c6 .} ==> r8c8≠2
...
There remains a Trid-OR4-relation between candidates: n3r1c7 n7r1c7 n8r4c9 n9r6c8
   ...
   ! 124   3     468   ! 9     7     126   ! 12468 5     1268  !
   ! 125   7     569   ! 126   4     8     ! 126   1269  3     !
   ! 1249  1269  4689  ! 5     126   3     ! 12468 1269  7     !
   +-------------------+-------------------+-------------------+
...
Trid-OR4-whip[5]: c3n8{r6 r4} - c3n4{r4 r2} - c3n7{r2 r1} - OR4{{n7r1c7 n9r6c8 n8r4c9 | n3r1c7}} - b1n3{r1c1 .} ==> r6c3≠9
z-chain[6]: b6n4{r6c7 r4c7} - c7n8{r4 r7} - r7c2{n8 n9} - c1n9{r7 r6} - r6n4{c1 c3} - r6n8{c3 .} ==> r6c7≠6, r6c7≠2, r6c7≠1
Trid-OR4-whip[6]: c1n9{r6 r7} - c1n3{r7 r1} - r1c3{n3 n7} - OR4{{n7r1c7 n9r6c8 n3r1c7 | n8r4c9}} - r8n8{c9 c2} - r7c2{n8 .} ==> r6c2≠9
...
naked-single ==> r7c1=3
naked-single ==> r8c9=2
PUZZLE 0 IS SOLVED. rating-type = W+OR5FW+OR5W+SFin+Trid, MOST COMPLEX RULE TRIED = W[7]
     +-------+-------+-------+
     ! 1 2 3 ! 4 5 6 ! 7 8 9 !
     ! 4 5 7 ! 1 8 9 ! 2 3 6 !
     ! 8 6 9 ! 3 2 7 ! 5 1 4 !
...
nb-facts = <Fact-290043>
Puzzle ...45..89....8....8..3.75.4.3.97..5..7..48..3...5.3..7..2.....56.1...9..74.8.....;1558;26960 :
computer = MacBookPro 16'' M1Max 2021, 64GB LPDDR5, MacOS 12.5
init-time = 0.09s, solve-time = 37.61s, total-time = 37.7s
***********************************************************************************************
***  SudoRules 20.1.s based on CSP-Rules 2.1.s, config = W+OR5FW+OR5W+SFin+Trid
***  Using CLIPS 6.32-r823
***  Running on MacBookPro 16'' M1Max 2021, 64GB LPDDR5, MacOS 12.5
