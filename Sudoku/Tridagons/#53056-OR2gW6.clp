...
! 9 8 4 ! . . . ! 5 . 7 !
+-------+-------+-------+
.2..567.....18.2.....2.7..52..7.58.1...86..72......65.3.5...1.8.125.8...984...5.7;10932;206235
SER = 10.4
...
naked-single ==> r8c5=4
naked-single ==> r7c4=9
PUZZLE 53056 IS SOLVED. rating-type = gW+OR5gW+SFin+Trid, MOST COMPLEX RULE TRIED = OR2W[8]
     +-------+-------+-------+
     ! 1 2 3 ! 4 5 6 ! 7 8 9 !
     ! 4 5 7 ! 1 8 9 ! 2 6 3 !
     ! 6 9 8 ! 2 3 7 ! 4 1 5 !
...
init-time = 0.07s, solve-time = 37.27s, total-time = 37.33s
nb-facts = <Fact-87185>
