...
(solve "...4..7.9.57.89.....9732....459...1.67....59.9.15..4...94..167...6...9.171..9....;418;")
***********************************************************************************************
...
***********************************************************************************************
...4..7.9.57.89.....9732....459...1.67....59.9.15..4...94..167...6...9.171..9....;418;
...
Entering_level_L2_with_<Fact-7310>
137 g-candidates, 607 csp-glinks and 361 non-csp glinks
Entering_level_L3_with_<Fact-9003>
   +-------------------+-------------------+-------------------+
   ! 1238  2368  238   ! 4     156   56    ! 7     2368  9     !
   ! 1234  5     7     ! 16    8     9     ! 123   2346  2346  !
   ! 148   68    9     ! 7     3     2     ! 18    4568  4568  !
...
Entering_level_L4_with_<Fact-10566>
...
hidden-pairs-in-a-row: r8{n4 n7}{c5 c6} ==> r8c6≠8, r8c6≠3, r8c5≠5
   ...
   +-------------------+-------------------+-------------------+
   ! 2358  9     4     ! 238   25    1     ! 6     7     2358  !
   ! 2358  238   6     ! 238   47    47    ! 9     2358  1     !
   ! 7     1     238   ! 2368  9     3568  ! 238   23458 23458 !
   +-------------------+-------------------+-------------------+

Trid-OR4-relation between candidates n6r6c8, n5r7c1, n5r7c9 and n5r8c8
+ same valence for candidates n5r8c8 and n5r7c1 via c-chain[2]: n5r8c8,n5r8c1,n5r7c1
==> Trid-OR4-relation can be split into two Trid-OR3-relations with respective lists of guardians:
    n6r6c8 n5r7c1 n5r7c9  and n6r6c8 n5r7c9 n5r8c8 .

Entering_level_L5_with_<Fact-14755>
Trid-OR3-forcing-whip-elim[5]:
   || n6r6c8 -
   || n5r7c9 - partial-whip[1]: c8n5{r9 r3} -
   || n5r7c1 - partial-whip[3]: c5n5{r7 r1} - r1c6{n5 n6} - c2n6{r1 r3} -
 ==> r3c8≠6
Trid-OR3-forcing-whip-elim[5]:
   || n6r6c8 -
...
naked-single ==> r3c7=1
Entering_level_L6_with_<Fact-26360>
Entering_level_L7_with_<Fact-40351>
whip[7]: c4n6{r9 r2} - b3n6{r2c9 r3c9} - r3c2{n6 n8} - b3n8{r3c8 r1c8} - r8n8{c8 c1} - r8n5{c1 c8} - r3n5{c8 .} ==> r9c4≠8
Entering_level_L8_with_<Fact-63441>
whip[8]: r5n4{c6 c5} - r5n1{c5 c4} - r2c4{n1 n6} - r1n6{c6 c2} - r3c2{n6 n8} - b4n8{r6c2 r4c1} - c7n8{r4 r9} - c3n8{r9 .} ==> r5c6≠8
whip[3]: c7n8{r9 r4} - c6n8{r4 r6} - b4n8{r6c2 .} ==> r9c3≠8
whip[4]: c1n5{r8 r7} - b7n8{r7c1 r8c2} - r8c4{n8 n2} - r7c5{n2 .} ==> r8c1≠3
...
t-whip[4]: r5n8{c3 c4} - c6n8{r6 r9} - c7n8{r9 r4} - b6n3{r4c7 .} ==> r5c3≠3
...
OR2-forcing-gwhip-elim[2]:
   || n5r7c9 -
   || n6r6c8 - partial-gwhip[1]: b6n2{r6c8 r456c9} -
 ==> r7c9≠2
...
naked-single ==> r5c4=2
naked-single ==> r8c6=7
PUZZLE 0 IS SOLVED. rating-type = gW+OR5FgW+SFin+Trid, MOST COMPLEX RULE TRIED = W[8]
     +-------+-------+-------+
     ! 1 2 3 ! 4 5 6 ! 7 8 9 !
     ! 4 5 7 ! 1 8 9 ! 2 3 6 !
     ! 8 6 9 ! 7 3 2 ! 1 5 4 !
...
nb-facts = <Fact-169003>
Puzzle ...4..7.9.57.89.....9732....459...1.67....59.9.15..4...94..167...6...9.171..9....;418; :
computer = MacBookPro 16'' M1Max 2021 3.2GHz, 64GB LPDDR5, MacOS 13.0.1
init-time = 0.09s, solve-time = 28.79s, total-time = 28.88s
***********************************************************************************************
***  SudoRules 20.1.s based on CSP-Rules 2.1.s, config = gW+OR5FgW+SFin+Trid
***  Using CLIPS 6.32-r823
***  Running on MacBookPro 16'' M1Max 2021 3.2GHz, 64GB LPDDR5, MacOS 13.0.1
