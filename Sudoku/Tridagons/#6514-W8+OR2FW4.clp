...
whip[6]: r3c3{n2 n9} - r9c3{n9 n1} - c2n1{r9 r5} - r5c5{n1 n3} - r5c9{n3 n9} - r1n9{c9 .} ==> r5c3≠2
   +-------------------------+-------------------------+-------------------------+
   ! 1       249     3       ! 2467    25      267     ! 2567    8       29      !
   ! 246     5       7       ! 12346   8       9       ! 1236    1236    123     !
   ! 2689    289     29      ! 12367   1235    12367   ! 123567  1235679 4       !
   ...
   ! 2389    12389   1459    ! 67      123     67      ! 48      12359   1239    !
   ! 239     7       1259    ! 123     4       8       ! 1235    12359   6       !
   +-------------------------+-------------------------+-------------------------+
...
OR2-anti-tridagon[12] (type antidiag) for digits 1, 3 and 2 in blocks:
...
OR2-forcing-whip-elim[2] based on OR2-anti-tridagon[12] for n9r5c9 and  n5r6c7:
   || n9r5c9 -
   || n5r6c7 - partial-whip[1]: r5n5{c8 c3} -
 ==> r5c3≠9
OR2-forcing-whip-elim[3] based on OR2-anti-tridagon[12] for n5r6c7 and  n9r5c9:
   || n5r6c7 -
   || n9r5c9 - partial-whip[2]: r1c9{n9 n2} - r1c5{n2 n5} -
 ==> r1c7≠5
hidden-single-in-a-row ==> r1c5=5
biv-chain[3]: r3n5{c7 c8} - c8n7{r3 r7} - b9n6{r7c8 r7c7} ==> r3c7≠6
OR2-forcing-whip-elim[3] based on OR2-anti-tridagon[12] for n5r6c7 and  n9r5c9:
   || n5r6c7 - partial-whip[1]: c8n5{r6 r3} -
   || n9r5c9 - partial-whip[1]: r1c9{n9 n2} -
 ==> r3c8≠2
OR2-forcing-whip-elim[3] based on OR2-anti-tridagon[12] for n5r6c7 and  n9r5c9:
   || n5r6c7 - partial-whip[1]: c8n5{r6 r3} -
   || n9r5c9 - partial-whip[1]: c8n9{r6 r3} -
 ==> r3c8≠7
...
OR2-forcing-whip-elim[3] based on OR2-anti-tridagon[12] for n5r6c7 and  n9r5c9:
   ...
   || n9r5c9 - partial-whip[1]: c8n9{r6 r3} -
 ==> r3c8≠1
biv-chain[4]: c3n4{r4 r5} - r5n5{c3 c8} - r3c8{n5 n9} - r3c3{n9 n2} ==> r4c3≠2
OR2-forcing-whip-elim[4] based on OR2-anti-tridagon[12] for n9r5c9 and  n5r6c7:
   || n9r5c9 -
   || n5r6c7 - partial-whip[3]: r5n5{c8 c3} - r5n4{c3 c7} - r5n8{c7 c1} -
 ==> r5c1≠9
hidden-single-in-a-block ==> r6c1=9
whip[5]: c8n9{r5 r3} - r3c3{n9 n2} - r6n2{c3 c4} - b2n2{r1c4 r1c6} - r1c9{n2 .} ==> r5c8≠2
whip[6]: r9n9{c2 c3} - r3c3{n9 n2} - r2c1{n2 n4} - r7c1{n4 n2} - b4n2{r4c1 r5c2} - c5n2{r5 .} ==> r9c2≠3
t-whip[8]: c8n3{r6 r8} - r9n3{c7 c6} - r4n3{c6 c1} - r7n3{c1 c2} - c2n4{r7 r1} - r1n9{c2 c9} - r3c8{n9 n5} - b6n5{r5c8 .} ==> r6c7≠3
whip[7]: c8n9{r5 r3} - c8n5{r3 r6} - r6n3{c8 c4} - r5c5{n3 n2} - r5c2{n2 n3} - r8n3{c2 c8} - r4n3{c8 .} ==> r5c8≠1
whip[8]: c8n9{r5 r3} - r3c3{n9 n2} - r2c1{n2 n4} - r7n4{c1 c2} - c2n3{r7 r8} - r7c1{n3 n2} - b4n2{r4c1 r5c2} - c5n2{r5 .} ==> r5c8≠3
naked-pairs-in-a-column: c8{r3 r5}{n5 n9} ==> r6c8≠5
whip[8]: c2n4{r7 r1} - r1n9{c2 c9} - r3n9{c8 c3} - b1n2{r3c3 r2c1} - c9n2{r2 r5} - r4n2{c8 c6} - b8n2{r9c6 r8c4} - c8n2{r8 .} ==> r7c2≠2
whip[8]: r1c9{n2 n9} - c2n9{r1 r9} - c3n9{r9 r3} - r3n2{c3 c7} - r9n2{c7 c3} - c2n2{r9 r5} - c9n2{r5 r7} - c5n2{r7 .} ==> r1c6≠2
...
nb-facts = <Fact-476951>
Puzzle 1.3....8..57.89...........4.6.59...7..........7..48..6..89.5...5.6.749.87..86..45;1395;145263 :
init-time = 0.07s, solve-time = 36.29s, total-time = 36.36s
***********************************************************************************************
***  SudoRules 20.1.s based on CSP-Rules 2.1.s, config = W+SFin+Trid
***  Using CLIPS 6.32-r823
***  Running on MacBookPro 16'' M1Max 2021 3.2GHz, 64GB LPDDR5, MacOS 12.5
