...
But it can be proven in T&E(3)

Be sure to scroll until the end, as several proofs are given.
...
It is much better (though not  a priori granted to reach the desired result) to use this focused version of T&E:
